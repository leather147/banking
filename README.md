...
- Пагинируемые операции с сортировкой, диапазоном дат 1893–2108 и аналитика счёта с прогнозом, аномалиями, комиссиями и финансовым индексом.
...
- Порядок навигации, быстрых действий, верхней панели и dashboard-блоков, выбор валюты отображения и двух паков иконок.
- Локальный код-пароль и кодовое слово с хешированием, настраиваемым периодом повторной проверки и цифровой экранной клавиатурой.
...
| UI | Radix UI, собственные shadcn-style primitives, Lucide React, Phosphor Icons |
...
| `bun run check` | ESLint, TypeScript, i18n-аудит и unit-тесты |
| `bun run test:unit` | Чистые unit-тесты доменной аналитики |
...
Подробности: [архитектура](./docs/ARCHITECTURE.md), [операции и состояние](./docs/OPERATIONS.md), [персонализация](./docs/PERSONALIZATION.md), [оценка Expo-приложения](./docs/EXPO_FEASIBILITY.md).
