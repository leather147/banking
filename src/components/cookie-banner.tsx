...
export function CookieBanner() {
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} className="cookie-banner fixed inset-x-2 z-50 mx-auto max-w-2xl sm:inset-x-3 md:bottom-5">
      <Card className="max-h-[min(68dvh,34rem)] overflow-y-auto overscroll-contain border-primary/25 bg-card/95 p-4 shadow-2xl backdrop-blur-xl sm:p-5">
