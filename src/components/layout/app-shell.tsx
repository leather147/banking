...
import { DynamicBackgroundController } from "@/components/providers/dynamic-background-controller";
...
export function AppShell({ children }: { children: React.ReactNode }) {
  return (
    <div className="app-grid h-dvh min-h-0 overflow-hidden">
      ...
      <div aria-hidden="true" className="dynamic-background-orb" />
      ...
      <div className="app-content flex h-dvh min-w-0 flex-col lg:pl-[248px]">
        ...
        <main id="app-scroll-region" className="app-scroll min-h-0 flex-1 overflow-y-auto overscroll-contain">
          <div className="app-page-frame mx-auto w-full max-w-[1600px] px-3 pt-5 sm:px-6 sm:pt-7 lg:px-8 lg:pb-10">
      ...
      <Suspense fallback={null}><DynamicBackgroundController /></Suspense>
      <LayoutEditorOverlay />
